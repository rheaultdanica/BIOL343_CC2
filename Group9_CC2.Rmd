...
1. **Danica Rheault** — 20414884
    + [BIOL343_CC](https://github.com/rheaultdanica/BIOL343_CC2)
1. 
...
---------------|-----------------|-----------
population_type|Asexual or sexual|A or S
---------------|-----------------|-----------
...
cc1_data_mod <-cc1_data[1:46,1:8]
cc1_data_mod$ovary_area = cc1_data_mod$ovary_width * cc1_data_mod$ovary_height
head(cc1_data_mod)
```
...
area_means <- aggregate(ovary_area ~ population_type, data = cc1_data_mod, mean)
...
library(knitr)
kable(cc1_data_mod, caption = "Area means")
```
...
ggplot(aes(x= ovary_area), data = cc1_data_mod) + geom_histogram(binwidth = 0.5, fill="blue") + facet_wrap(vars(population_type))+ labs(x="Ovary Area (mm)", y="Count") + theme_classic()
```
...
![Solanum pimpinellifolium](./images/solanum-pimpinellifolium-53896efb-abfb-4aab-b84a-8f48db02df4-resize-750.webp)

Source: https://alchetron.com/cdn/solanum-pimpinellifolium-53896efb-abfb-4aab-b84a-8f48db02df4-resize-750.jpg
